...
export default function CryptoPriceTracker() {
  ...
  return (
    <>
      <Head>
        <title>Crypto Price Tracker with D3.js | Venkata Janapareddy</title>
        <meta name="description" content="Real-time cryptocurrency price tracking with advanced D3.js visualizations and market analytics" />
      </Head>
