...
export default function PersonalFinanceTracker() {
  ...
  return (
    <>
      <Head>
        <title>Transaction Analytics Dashboard with Chart.js | Venkata Janapareddy</title>
        <meta name="description" content="Multi-chart dashboard for transaction analytics with category-based aggregation and monthly trend analysis" />
      </Head>
