...
const projectsData = [
  ...
  {
    id: 'election-2024',
    title: 'Presidential Election Results Dashboard with Highcharts',
    date: '2025-02-24',
    description: 'Presidential election results with interactive state map, county level data and historical comparisons',
    tech: ['TypeScript', 'React', 'Highcharts', 'Highmaps', 'Ant Design'],
    url: '/projects/election-2024'
  }
]
